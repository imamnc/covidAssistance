...
public class DetailPositifActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_positif);
        ...
        btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                new HelperDatabasePositif().updatePositif(detailKey.getText().toString(), kasus, new HelperDatabasePositif.DataStatus() {
                    @Override
